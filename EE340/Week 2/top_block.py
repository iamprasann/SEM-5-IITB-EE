...
# Title: Top Block
# Generated: Tue Aug 17 16:51:31 2021
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(30, firdes.low_pass(
        	1, samp_rate, 15000, 500, firdes.WIN_HAMMING, 6.76))
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/iamprasann/Desktop/EE340-Comms. Lab/Week 2/lab2_task4.dat', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15000, 500, firdes.WIN_HAMMING, 6.76))
