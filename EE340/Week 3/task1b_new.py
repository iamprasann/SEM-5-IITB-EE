...
class task1b_new(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "task1b_new")
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = 3528000
    ...
    def set_samp_rate_0(self, samp_rate_0):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate_0, 15000, 1000, firdes.WIN_KAISER, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate_0, 15000, 1000, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_1_0.set_taps(firdes.low_pass(1, self.samp_rate_0, 15000, 1000, firdes.WIN_HAMMING, 6.76))
        self.qtgui_sink_x_1.set_frequency_range(0, self.samp_rate_0)
...
def main(top_block_cls=task1b_new, options=None):
