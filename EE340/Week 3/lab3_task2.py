...
class lab3_task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/iamprasann/Desktop/EE340-Comms. Lab/Week 3/music_mod.dat', True, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_2, 0), (self.blocks_sub_xx_1, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_2, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_2, 1))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_sub_xx_0_0, 0))
        self.connect((self.blocks_sub_xx_0_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.blocks_sub_xx_1, 0), (self.blocks_abs_xx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_transcendental_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.dc_blocker_xx_0, 0), (self.rational_resampler_xxx_3, 0))
        self.connect((self.rational_resampler_xxx_2, 0), (self.dc_blocker_xx_0, 0))
        self.connect((self.rational_resampler_xxx_3, 0), (self.audio_sink_0, 0))
        self.connect((self.rational_resampler_xxx_3, 0), (self.blocks_throttle_0, 0))
