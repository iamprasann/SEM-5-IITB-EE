...
class lab3_task1a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 3 Task 1a")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 3 Task 1a")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab3_task1a")
...
def main(top_block_cls=lab3_task1a, options=None):
