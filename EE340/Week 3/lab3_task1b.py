...
# Title: Lab 3 Task 1b
# Author: Prsn
# GNU Radio version: v3.8.3.1-19-g5fb102b8
...
class lab3_task1b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate_op = samp_rate_op = 44100
        self.samp_rate_car = samp_rate_car = 3582000
        self.samp_rate = samp_rate = 32000
        self.carrier = carrier = 200000
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iir_filter_xxx_2 = filter.iir_filter_ffd([1], [1, -0.95], True)
        self.iir_filter_xxx_1 = filter.iir_filter_ffd([0.0000226757], [1, 1], True)
        self.iir_filter_xxx_0 = filter.iir_filter_ffd([1, -0.95], [1], True)
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(32, True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/iamprasann/Desktop/EE340-Comms. Lab/Week 3/music.wav', True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate_car, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.rational_resampler_xxx_2, 0))
        ...
        self.connect((self.iir_filter_xxx_2, 0), (self.rational_resampler_xxx_3, 0))
        ...
        self.connect((self.rational_resampler_xxx_2, 0), (self.iir_filter_xxx_2, 0))
        self.connect((self.rational_resampler_xxx_3, 0), (self.dc_blocker_xx_0, 0))
    ...
    def get_samp_rate_op(self):
        return self.samp_rate_op

    def set_samp_rate_op(self, samp_rate_op):
        self.samp_rate_op = samp_rate_op

    def get_samp_rate_car(self):
        return self.samp_rate_car

    def set_samp_rate_car(self, samp_rate_car):
        self.samp_rate_car = samp_rate_car
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate_car)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, 14000, 100, firdes.WIN_HAMMING, 6.76))
