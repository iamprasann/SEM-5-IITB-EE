...
# Title: Top Block
# Generated: Tue Aug 10 16:20:22 2021
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/iamprasann/Desktop/EE340-Comms. Lab/Week 1/Audio Files/shor.wav', True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.band_pass_filter_0 = filter.fir_filter_fff(1, firdes.band_pass(
        	1, samp_rate, 100, 5400, 100, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 100, 5400, 100, firdes.WIN_HAMMING, 6.76))
