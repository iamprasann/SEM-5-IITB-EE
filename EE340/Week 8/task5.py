...
class task5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 8 - task 5")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 8 - task 5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "task5")
        ...
        self.connect((self.blocks_multiply_xx_1_0, 0), (self.blocks_throttle_0, 0))
...
def main(top_block_cls=task5, options=None):
