...
class task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab 8 - Task 2")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 10, 1, 0, 0)
        ...
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.blocks_multiply_xx_1_0_0, 1))
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_multiply_xx_1_0, 1))
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_multiply_xx_1_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_1_0_0, 0), (self.blocks_sub_xx_0, 1))
