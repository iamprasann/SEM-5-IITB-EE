...
class task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Task 2")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/iamprasann/Desktop/EE340-Comms. Lab/Week 4/vocal.wav', True)
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_float*1, samp_rate_1,True)
        ...
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate_1, analog.GR_COS_WAVE, 500000, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate_1, analog.GR_COS_WAVE, 500000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate_1, analog.GR_SIN_WAVE, 500000, -1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.rational_resampler_xxx_1, 0))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_sink_x_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_2, 0), (self.dc_blocker_xx_0, 0))
    ...
    def set_samp_rate_1(self, samp_rate_1):
        ...
        self.analog_sig_source_x_2.set_sampling_freq(self.samp_rate_1)
        self.analog_sig_source_x_3.set_sampling_freq(self.samp_rate_1)
        self.blocks_throttle_1.set_sample_rate(self.samp_rate_1)
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate_1, 15000, 1000, firdes.WIN_HAMMING, 6.76))
        self.qtgui_sink_x_1.set_frequency_range(0, self.samp_rate_1)
