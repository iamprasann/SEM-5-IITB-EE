...
class lab5_task2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 5 Task 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 5 Task 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5_task2")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'C:\\Users\\HOME\\Desktop\\SEM 5\\EE340 - Comms. Lab\\Lab 6\\task1.bin', True, 0, 0)
...
def main(top_block_cls=lab5_task2, options=None):
