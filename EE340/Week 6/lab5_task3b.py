...
class lab5_task3b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 5 Task 3b")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 5 Task 3b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5_task3b")
        ...
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(16, sps, 0.01, 1)
        self.blocks_throttle_0_0_0_1 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate*sps,True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'C:\\Users\\HOME\\Desktop\\SEM 5\\EE340 - Comms. Lab\\Lab 6\\input2.bin', True, 0, 0)
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.blocks_throttle_0_0_0_0, 0))
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_throttle_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_throttle_0_0_0_1, 0))
    ...
    def set_sps(self, sps):
        ...
        self.blocks_throttle_0_0_0_1.set_sample_rate(self.samp_rate*self.sps)
        self.digital_cma_equalizer_cc_0.set_modulus(self.sps)
...
def main(top_block_cls=lab5_task3b, options=None):
