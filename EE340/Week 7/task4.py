...
class task4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Task 4")
        ...
        self._gain_range = Range(0, 1, 0.0001, 0.5, 200)
        ...
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(4, 1, gain, sps)
        ...
        self.connect((self.blocks_add_xx_0_0_0, 0), (self.digital_cma_equalizer_cc_0, 0))
        ...
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.blocks_throttle_0_0_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_add_xx_0, 0))
